...
{
    public class AgendamientoCitasMedicoController : Controller
    {
        private readonly CMContext _context;
        public AgendamientoCitasMedicoController(CMContext context)
        {
            _context = context;
        }
        ...
        public void Combox()
        {
            ...
            ViewData["Paciente"] = new SelectList(_context.CqasPaciente.Select(x => new CqasPersona
            {
                Codigo = x.Codigo,
                Nombre = string.Format("{1} {0}", x.CodigoPersonaNavigation.Nombre, x.CodigoPersonaNavigation.Apellido)
